...
Public Class frmAutoTyper
    ...
    Private Sub txtMins_TextChanged(sender As Object, e As EventArgs) Handles txtMins.TextChanged

    End Sub

    Private Sub txtMilli_TextChanged(sender As Object, e As EventArgs) Handles txtMilli.TextChanged

    End Sub

    Private Sub txtSecs_TextChanged(sender As Object, e As EventArgs) Handles txtSecs.TextChanged
    ...
    Private Sub nudRepeat_ValueChanged(sender As Object, e As EventArgs) Handles nudRepeat.ValueChanged

    End Sub

    Private Sub rbnLoop_CheckedChanged(sender As Object, e As EventArgs) Handles rbnLoop.CheckedChanged

    End Sub

    Private Sub rbnRepeat_CheckedChanged(sender As Object, e As EventArgs) Handles rbnRepeat.CheckedChanged
